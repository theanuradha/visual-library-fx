...
public class GridGraphLayoutTest extends StringGraphScene {
	...
	public static void main(String[] args) {
		SceneSupport.show(() -> {
			...
			return new GridGraphLayoutTest();
	...
	private static class MyListener implements GraphLayoutListener<String, String> {
		...
		public void nodeLocationChanged(UniversalGraph<String, String> graph, String node,
				Point previousPreferredLocation, Point newPreferredLocation) {
