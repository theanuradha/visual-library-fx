...
public class IconNodeHeaderTest {
	...
	public static void main(String[] args) {
		...
		theWidgetWithHeader.setPreferredLocation(new Point(100, 100)); // the
																		// reference
																		// point
																		// of
																		// the
		...
		final LabelWidget header = new LabelWidget(scene,
				"Visibility of this label should not affect the position of the top-left corner of the image in the scene.");
		header.setPreferredLocation(new Point(0, 0)); // the location of the
														// header relatively to
														// the reference point
		...
		widget.setPreferredLocation(new Point(0, 0)); // the location of icon
														// node widget
														// relatively to the
														// reference point
