...
public class ImageAnchorShapeTest {
	...
	public static void main(String[] args) {
		...
		child.setSourceAnchorShape(AnchorShapeFactory
				.createImageAnchorShape(Utilities.loadImage("test/resources/custom_displayable_32.png"), true)); // NOI18N
		child.setTargetAnchorShape(AnchorShapeFactory
				.createImageAnchorShape(Utilities.loadImage("test/resources/custom_displayable_32.png"), true)); // NOI18N
