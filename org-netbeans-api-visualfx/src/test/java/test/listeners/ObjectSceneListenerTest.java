...
public class ObjectSceneListenerTest extends ObjectTest implements ObjectSceneListener {
	...
	public void objectStateChanged(ObjectSceneEvent event, Object changedObject, ObjectState previousState,
		...
		System.out.println("changedObject = " + changedObject + " | previousState = " + previousState + " | newState = "
				+ newState);
	}
	...
	public void highlightingChanged(ObjectSceneEvent event, Set<Object> previousHighlighting,
		...
		System.out
				.println("previousHighlighting = " + previousHighlighting + " | newHighlighting = " + newHighlighting);
	}

	public void hoverChanged(ObjectSceneEvent event, Object previousHoveredObject, Object newHoveredObject) {
		System.out.println(
				"previousHoveredObject = " + previousHoveredObject + " | newHoveredObject = " + newHoveredObject);
	}

	public void focusChanged(ObjectSceneEvent event, Object previousFocusedObject, Object newFocusedObject) {
		System.out.println(
				"previousFocusedObject = " + previousFocusedObject + " | newFocusedObject = " + newFocusedObject);
	}
