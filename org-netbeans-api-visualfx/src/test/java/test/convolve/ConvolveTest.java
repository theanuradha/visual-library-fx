...
import org.netbeans.api.visual.widget.ConvolveWidget;
...
public class ConvolveTest extends Scene {
	...
	Kernel blurKernel = new Kernel(5, 5,
			new float[] { 0.00f, 0.00f, 0.05f, 0.00f, 0.00f, 0.00f, 0.05f, 0.10f, 0.05f, 0.00f, 0.05f, 0.10f, 0.20f,
					0.10f, 0.05f, 0.00f, 0.15f, 0.10f, 0.05f, 0.00f, 0.00f, 0.00f, 0.05f, 0.00f, 0.00f, });

	Kernel dropShadowKernel = new Kernel(5, 5,
			new float[] { 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 1.00f,
					0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.30f, });
	...
	public ConvolveTest() {
		...
		createConvolveWidget(dropShadowKernel, 150, 250,
				"This is ConvolveWidget - the image with label has to drop shadow");
	}
