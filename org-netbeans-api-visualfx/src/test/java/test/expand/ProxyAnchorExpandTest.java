...
public class ProxyAnchorExpandTest extends Scene {
	...
	public ProxyAnchorExpandTest() {
		...
		outerWidget.addChild(
				new LabelWidget(this, "The anchor switches based on a state in StateModel used by ProxyAnchor."));
		...
		// an action for switching a state of a StateModel used by the
		// ProxyAnchor to determinate an active anchor
