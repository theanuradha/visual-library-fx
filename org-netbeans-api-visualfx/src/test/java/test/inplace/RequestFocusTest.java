...
public class RequestFocusTest {
	...
	public static void main(String[] args) {
		...
		final JButton button = new JButton(
				"Press me while you are in in-place editing. The focus should be on the button.");
		...
		LabelWidget label = new LabelWidget(scene,
				"Double-click on this label to invoke edit, then click on the icon in toolbar to trace the focus behaviour.");
