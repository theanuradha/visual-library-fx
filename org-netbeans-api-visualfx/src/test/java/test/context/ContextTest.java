...
public class ContextTest {
	...
	// HINT - test: press mouse button on the "95,95" label and release the
	// button when the mouse is over "100,100" label
	// -> then the "100,100" label should change its background color when the
