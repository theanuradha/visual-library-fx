...
public class VMDTest {
	...
	static void runScene(final VMDGraphScene scene) {
		...
		String game = createNode(scene, 600, 100, IMAGE_CANVAS, "gameCanvas", "MyCanvas",
				Arrays.asList(GLYPH_PRE_CODE, GLYPH_CANCEL, GLYPH_POST_CODE));
		...
		categories.put("Elements", Arrays.asList(scene.findWidget("game"), scene.findWidget("options"),
				scene.findWidget("help"), scene.findWidget("exit")));
	...
	static String createNode(VMDGraphScene scene, int x, int y, Image image, String name, String type,
			List<Image> glyphs) {
	...
	static void createPin(VMDGraphScene scene, String nodeID, String pinID, Image image, String name, String type) {
		...
		// uncomment this in case, you would like to allow to move a node by
		// dragging any area of the node (including pins)
		// final Widget nodeWidget = scene.findWidget (nodeID);
		// final WidgetAction originalMoveAction =
		// ActionFactory.createMoveAction ();
		//
		// pinWidget.getActions ().addAction (new WidgetAction() {
		//
		// public State mouseClicked (Widget widget, WidgetMouseEvent event) {
		// Point point = nodeWidget.convertSceneToLocal
		// (widget.convertLocalToScene (event.getPoint ()));
		// return originalMoveAction.mouseClicked (nodeWidget, new
		// WidgetMouseEvent (event.getEventID (), new MouseEvent
		// (widget.getScene ().getView (), 0, event.getWhen (),
		// event.getModifiersEx (), point.x, point.y, event.getClickCount (),
		...
		// Point point = nodeWidget.convertSceneToLocal
		// (widget.convertLocalToScene (event.getPoint ()));
		// return originalMoveAction.mousePressed (nodeWidget, new
		// WidgetMouseEvent (event.getEventID (), new MouseEvent
		// (widget.getScene ().getView (), 0, event.getWhen (),
		// event.getModifiersEx (), point.x, point.y, event.getClickCount (),
		// event.isPopupTrigger (), event.getButton ())));
		...
		// Point point = nodeWidget.convertSceneToLocal
		// (widget.convertLocalToScene (event.getPoint ()));
		// return originalMoveAction.mouseReleased (nodeWidget, new
		// WidgetMouseEvent (event.getEventID (), new MouseEvent
		// (widget.getScene ().getView (), 0, event.getWhen (),
		// event.getModifiersEx (), point.x, point.y, event.getClickCount (),
		// event.isPopupTrigger (), event.getButton ())));
		...
		// Point point = nodeWidget.convertSceneToLocal
		// (widget.convertLocalToScene (event.getPoint ()));
		// return originalMoveAction.mouseEntered (nodeWidget, new
		// WidgetMouseEvent (event.getEventID (), new MouseEvent
		// (widget.getScene ().getView (), 0, event.getWhen (),
		// event.getModifiersEx (), point.x, point.y, event.getClickCount (),
		// event.isPopupTrigger (), event.getButton ())));
		...
		// Point point = nodeWidget.convertSceneToLocal
		// (widget.convertLocalToScene (event.getPoint ()));
		// return originalMoveAction.mouseExited (nodeWidget, new
		// WidgetMouseEvent (event.getEventID (), new MouseEvent
		// (widget.getScene ().getView (), 0, event.getWhen (),
		// event.getModifiersEx (), point.x, point.y, event.getClickCount (),
		// event.isPopupTrigger (), event.getButton ())));
		...
		// Point point = nodeWidget.convertSceneToLocal
		// (widget.convertLocalToScene (event.getPoint ()));
		// return originalMoveAction.mouseDragged (nodeWidget, new
		// WidgetMouseEvent (event.getEventID (), new MouseEvent
		// (widget.getScene ().getView (), 0, event.getWhen (),
		// event.getModifiersEx (), point.x, point.y, event.getClickCount (),
		// event.isPopupTrigger (), event.getButton ())));
		...
		// Point point = nodeWidget.convertSceneToLocal
		// (widget.convertLocalToScene (event.getPoint ()));
		// return originalMoveAction.mouseMoved (nodeWidget, new
		// WidgetMouseEvent (event.getEventID (), new MouseEvent
		// (widget.getScene ().getView (), 0, event.getWhen (),
		// event.getModifiersEx (), point.x, point.y, event.getClickCount (),
		// event.isPopupTrigger (), event.getButton ())));
		// }
		//
		// public State mouseWheelMoved (Widget widget, WidgetMouseWheelEvent
		// event) {
		// Point point = nodeWidget.convertSceneToLocal
		// (widget.convertLocalToScene (event.getPoint ()));
		// return originalMoveAction.mouseWheelMoved (nodeWidget, new
		// WidgetMouseWheelEvent (event.getEventID (), new MouseWheelEvent
		// (widget.getScene ().getView (), 0, event.getWhen (),
		// event.getModifiersEx (), point.x, point.y, event.getClickCount (),
		// event.isPopupTrigger (), event.getScrollType (),
		...
		// }
		//
		// public State dragEnter (Widget widget, WidgetDropTargetDragEvent
		// event) {
		// return originalMoveAction.dragEnter (nodeWidget, event);
		// }
		//
		// public State dragOver (Widget widget, WidgetDropTargetDragEvent
		// event) {
