...
public class MultipleWidgetsTest extends ObjectScene implements ObjectSceneListener {
	...
	public static void main(String[] args) {
		...
		scene.addObject("First Object", scene.createAddWidget("First widget - mapped to the first object", 100, 100),
				scene.createAddWidget("Second widget - mapped to the first object", 450, 100));

		scene.addObject("Second Object", scene.createAddWidget("Third widget - mapped to the second object", 100, 200),
