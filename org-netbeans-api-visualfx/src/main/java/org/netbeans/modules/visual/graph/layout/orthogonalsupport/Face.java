...
public class Face {
	...
	/**
	 * RESOLVE: This should be a O(1) operation instead of a linear operation.
	 * 
	 * @param e
	 * @return
	 */
	...
	/**
	 * RESOLVE: Can't really use a Map here because there can be multiple
	...
	/**
	 * The difference between a Dart and and Edge is that Dart has direction.
	 * Each edge can have two Darts going in the opposite direction.
	 */
