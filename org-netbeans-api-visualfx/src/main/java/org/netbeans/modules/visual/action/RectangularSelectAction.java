...
public final class RectangularSelectAction extends WidgetAction.LockedAdapter {
	...
	public RectangularSelectAction(RectangularSelectDecorator decorator, LayerWidget interractionLayer,
	...
	private void resolveSelectionWidgetLocationBounds() {
		...
		selectionWidget
				.setPreferredBounds(new Rectangle(w >= 0 ? 0 : w, h >= 0 ? 0 : h, w >= 0 ? w : -w, h >= 0 ? h : -h));
	}
