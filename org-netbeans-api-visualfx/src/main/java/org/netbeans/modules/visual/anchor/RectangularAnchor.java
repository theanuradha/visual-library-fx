 ...
 * @author David Kaspar
 */
// TODO - scene component location is not 100% attach to the bounding rectangle
// when the line goes far to the bottom-left-bottom direction
public final class RectangularAnchor extends Anchor {
	...
	// this is used by the Orthogonal Router. This router routes to the center
	// of
	...
	public List<Point> compute(List<Point> points) {
		...
		// the related location is the center of this anchor. It is possible
		// that
		// the list of points started at the opposite anchor (other end of
		// connection).
	...
	public Result compute(Entry entry) {
		...
		Result boundaryIntersection = computeBoundaryIntersectionPoint(relatedLocation, oppositeLocation);
