...
/**
 * Takes the generic nodes and edges from a GraphScene and lays them out
 * orthogonally. Note that the OrthogonalRouter is used to route the edges
 * instead of adding extra control points during the orthogonalizing.
 */
public class OrthogonalLayout<N, E> extends GraphLayout {
	 ...
	 * orthogonal layout uses the OrthogonalRouter to route the edges once it
	 * has completed laying out the nodes.
	 * 
	 * @param scene
	 *            the scene containing the nodes and edges.
	 */
	 ...
	 * 
	 * @param graph
	 *            the UniversalGraph created in UniversalGraph.layoutGraph
	 */
	@Override
