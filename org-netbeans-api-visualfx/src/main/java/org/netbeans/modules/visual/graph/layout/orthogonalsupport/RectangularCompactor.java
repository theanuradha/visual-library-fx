...
public class RectangularCompactor {
	 ...
	 * @param visitedFaces
	 */
	private void assignEdgeDirections(OrthogonalShape shape, Edge startingEdge, OrthogonalRepresentation or,
			Set<Face> visitedFaces) {
		Face face = shape.getFace();
	...
	private void refineShapes(OrthogonalRepresentation or) {
		...
		for (OrthogonalShape shape : or.getShapes()) {
			...
			// We will deal with outer face separately because it is a special
			// case.
			if (face.isOuterFace()) {
				outerShape = shape;
				continue;
	 ...
	 * @param edgeMap
	 */
	private void refineShape(OrthogonalShape shape, OrthogonalRepresentation or, Map<Edge, Collection<Edge>> edgeMap) {
	 ...
	 * @return
	 */
	private boolean refineShapeSub(OrthogonalShape shape, MGraph originalGraph, Map<Edge, Collection<Edge>> edgeMap) {
		Face face = shape.getFace();
	 ...
	 * @param or
	 */
	private void addDummyOuterFace(OrthogonalShape shape, OrthogonalRepresentation or) {
