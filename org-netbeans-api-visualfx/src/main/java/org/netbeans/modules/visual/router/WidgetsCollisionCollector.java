			...
			if (widget instanceof ConnectionWidget) {
				...
				for (int i = 0; i < last; i++) {
					...
					if (point1.x == point2.x) {
						Rectangle rectangle = new Rectangle(point1.x, Math.min(point1.y, point2.y), 0,
						...
						Rectangle rectangle = new Rectangle(Math.min(point1.x, point2.x), point1.y,
								Math.abs(point2.x - point1.x), 0);
						rectangle.grow(OrthogonalSearchRouter.SPACING_EDGE, OrthogonalSearchRouter.SPACING_EDGE);
