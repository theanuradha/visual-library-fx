...
public final class CircularAnchor extends Anchor {
	...
	public Result compute(Entry entry) {
		...
		Point location = new Point(relatedLocation.x + (int) (radius * Math.cos(angle)),
				relatedLocation.y + (int) (radius * Math.sin(angle)));
		return new Anchor.Result(location, Anchor.DIRECTION_ANY); // TODO -
																	// resolve
																	// direction
	}
