...
public final class ResizeBorder implements Border {
	...
	public void paint(Graphics2D gr, Rectangle bounds) {
		...
		if (outer)
			...
			gr.draw(new Rectangle2D.Double(bounds.x + thickness + 0.5, bounds.y + thickness + 0.5,
					bounds.width - thickness - thickness - 1.0, bounds.height - thickness - thickness - 1.0));
		gr.setStroke(stroke);
