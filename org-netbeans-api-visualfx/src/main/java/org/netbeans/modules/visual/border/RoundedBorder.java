...
public final class RoundedBorder implements Border {
	...
	public RoundedBorder(int arcWidth, int arcHeight, int insetWidth, int insetHeight, Color fillColor,
			Color drawColor) {
	...
	public RoundedBorder(int arcWidth, int arcHeight, int insetWidth, int insetHeight, String fillProperty,
			String drawProperty, Widget assocaited) {
		this(arcWidth, arcHeight, insetWidth, insetHeight, fillProperty, drawProperty, assocaited.getResourceTable());
	}

	public RoundedBorder(int arcWidth, int arcHeight, int insetWidth, int insetHeight, String fillProperty,
			String drawProperty, ResourceTable table) {
		this.arcWidth = arcWidth;
		this.arcHeight = arcHeight;
		this.insetWidth = insetWidth;
		this.insetHeight = insetHeight;
	...
	public void paint(Graphics2D gr, Rectangle bounds) {
		...
		if (drawColor != null) {
			...
			gr.draw(new RoundRectangle2D.Float(bounds.x + 0.5f, bounds.y + 0.5f, bounds.width - 1, bounds.height - 1,
					arcWidth, arcHeight));
		}
	}
