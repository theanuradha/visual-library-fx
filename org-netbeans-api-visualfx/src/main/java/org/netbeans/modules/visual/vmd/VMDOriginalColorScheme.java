...
public class VMDOriginalColorScheme extends VMDColorScheme {
	...
	public static final Border BORDER_NODE = VMDFactory.createVMDNodeBorder(COLOR_NORMAL, 1, COLOR1, COLOR2, COLOR3,
			COLOR4, COLOR5);
	...
	static final PointShape POINT_SHAPE_IMAGE = PointShapeFactory
			.createImagePointShape(Utilities.loadImage("org/netbeans/modules/visual/resources/vmd-pin.png")); // NOI18N
	...
	public Image getMinimizeWidgetImage(VMDNodeWidget widget) {
		return widget.isMinimized() ? Utilities.loadImage("org/netbeans/modules/visual/resources/vmd-expand.png") // NOI18N
	...
	public void updateUI(VMDPinWidget widget, ObjectState previousState, ObjectState state) {
		...
		// (BorderFactory.createEmptyBorder (8, 2), lookFeel.getMiniBorder
		// (state)));
