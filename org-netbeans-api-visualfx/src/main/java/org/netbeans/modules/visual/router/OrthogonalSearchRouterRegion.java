...
final class OrthogonalSearchRouterRegion extends Rectangle {
	...
	public OrthogonalSearchRouterRegion(
			/* OrthogonalLinkRouterRegion parentRegion, */int x, int y, int width, int height,
			Anchor.Direction direction, int depth) {
	...
	public int compareImportant(Rectangle collisionToCheck, Rectangle currentMostImportant) {
		...
		switch (direction) {
		case LEFT:
			return (currentMostImportant.x + currentMostImportant.width)
					- (collisionToCheck.x + collisionToCheck.width);
		case RIGHT:
			return collisionToCheck.x - currentMostImportant.x;
		case TOP:
			return (currentMostImportant.y + currentMostImportant.height)
					- (collisionToCheck.y + collisionToCheck.height);
		case BOTTOM:
	...
	private OrthogonalSearchRouterRegion cloneWithEdge(
			/* OrthogonalLinkRouterRegion parent, */Anchor.Direction dir, int depth) {
		switch (dir) {
		case LEFT:
