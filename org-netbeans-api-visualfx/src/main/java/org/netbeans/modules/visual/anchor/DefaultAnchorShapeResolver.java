...
public class DefaultAnchorShapeResolver implements AnchorShapeLocationResolver {
	...
	public DefaultAnchorShapeResolver(ConnectionWidget connection, ConnectionEnd attachedTo) {
		this(connection, attachedTo, null);
	}

	public DefaultAnchorShapeResolver(ConnectionWidget connection, ConnectionEnd attachedTo, Widget attachedWidget) {
		...
		if (widgetBounds != null) {
			...
			if ((endPt.x == (widgetBounds.x + widgetBounds.width)) && (endPt.y == widgetBounds.y)) {
				...
				retVal = bounds.width;
					...
					&& (endPt.y == (widgetBounds.y + widgetBounds.height))) {
