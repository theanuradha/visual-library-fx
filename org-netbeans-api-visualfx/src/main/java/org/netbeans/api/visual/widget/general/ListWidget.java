...
/**
 * This class represents a general list widget which is rendered as a rectangle
 * with a header on top and list item widgets underneath.
 *
 * @deprecated
 * @author David Kaspar
 */
public class ListWidget extends Widget {
	...
	public void notifyStateChanged(ObjectState previousState, ObjectState state) {
		...
		header.setBorder(
				BorderFactory.createCompositeBorder(BorderFactory.createEmptyBorder(2), lookFeel.getBorder(state)));
