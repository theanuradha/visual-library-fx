...
/**
 * This class represents an anchor for connections. An anchor is usually
 * attached to widget and resolves a source or target point of a connection
 * where it is used. Single instance of an anchor could be used by multiple
 * entries. An entry represents the place where the anchor is used. An anchor
 * can by attached to so-called proxy-anchor also. The proxy-anchor uses a set
 * of anchor and allows smooth switching of the active anchor.
 *
 * @author David Kaspar
 */
public abstract class Anchor implements Widget.Dependency {
	...
	/**
	 * The direction of the anchor. Used by orthogonal routing alogorithms to
	 * resolve which way the path can be directed.
	 */
	 ...
	 * 
	 * @param relatedWidget
	 *            the related widget; if null then the anchor is not related to
	 *            any widget
	 */
	...
	/**
	 * This method is called by revalidation-change of related widget and
	 * notifies all entries about the anchor change.
	 */
	...
	/**
	 * Represents calculated scene location and orthogonal direction(s) of an
	 * anchor. Usually created within Anchor.compute method and used by Router.
	 */
	public final class Result {
		 ...
		 * 
		 * @param anchorSceneLocation
		 *            the scene location of an anchor
		 * @param direction
		 *            the single direction of an anchor
		 */
		...
		/**
		 * Creates a result with calculated scene location and possible
		 * directions.
		 * 
		 * @param anchorSceneLocation
		 *            the scene location of an anchor
		 * @param directions
		 *            the possible directions of an anchor
		 */
	...
	/**
	 * Represents a place where an anchor is used. Usually it is implemented by
	 * ConnectionWidget.getSourceAnchorEntry or
	 * ConnectionWidget.getTargetAnchorEntry or ProxyAnchor.
	 */
	public interface Entry {

		/**
		 * Called for notifying that an anchor is changed and the entry has to
		 * me revalidated too. Usually called by Anchor.revalidateDependency.
		 */
		...
		/**
		 * Returns whether an entry is attached to the source or the target of a
		 * connection widget.
		 * 
		...
		/**
		 * Returns an anchor of a connection widget which is opposite to the
		 * related anchor
		 * 
