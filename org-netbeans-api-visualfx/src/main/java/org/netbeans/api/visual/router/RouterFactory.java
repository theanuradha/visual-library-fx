...
/**
 * This class creates built-in routers. All implementations can be shared by
 * multiple widgets.
 *
 * @author David Kaspar
 */
public final class RouterFactory {
	...
	/**
	 * Creates a direct router. The path is direct (single-segment) line between
	 * source and target anchor of a connection widget. The instance can be
	...
	/**
	 * Creates a free router. The path persist control points created by users
	 * using AddRemoveControlPointAction. The instance can be shared by multiple
	 * widgets.
	 * 
	...
	/**
	 * Creates an orthogonal search router. The router gathers collision regions
	 * from widget that are placed in specified layers. The instance can be
	 * shared by multiple widgets.
	 * 
	 * @param layers
	 *            the layers with widgets taken as collisions regions
	...
	/**
	 * Creates an orthogonal search router. The router uses collision regions
	 * from specified collector. The instance can be shared by multiple widgets.
	 * 
	 * @param collector
	...
	/**
	 * Creates collision collector based on specified layers. The boundaries of
	 * widgets in specified layers are taken The instance can be shared by
	 * multiple widgets. as collision regions.
	 * 
	 * @param layers
	 *            the layers with widgets
	...
	/**
	 * Creates an orthogonal search router. The router uses collision regions
	 * from specified collector with a connection widget context. The instance
