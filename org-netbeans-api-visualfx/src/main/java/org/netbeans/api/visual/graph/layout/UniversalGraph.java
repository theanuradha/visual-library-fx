...
/**
 * This interface represents an universal graph. It unifies a view on a
 * GraphScene and GraphPinScene as a nodes-edges only graph. This is commonly
 * used by graph-oriented layout algorithms.
 *
 * @author David Kaspar
 */
public abstract class UniversalGraph<N, E> {
	 ...
	 * @param node
	 *            the node
	 * @param allowsOutputEdges
	 *            if true then it finds all edges that has the node as their
	 *            source
	 * @param allowsInputEdges
	 *            if true then it finds all edges that has the node as their
	 *            target
