...
public class TreeGraphLayout<N, E> extends GraphLayout {
	 ...
	 * 
	 * @param scene
	 *            the GraphScene where the layout is used
	 * @param originX
	 *            the x-axis origin
	 * @param originY
	 *            the y-axis origin
	 ...
	 *            then horizontally
	 */
	public TreeGraphLayout(GraphScene<N, E> scene, int originX, int originY, int verticalGap, int horizontalGap,
			boolean vertical) {
		this.scene = scene;
