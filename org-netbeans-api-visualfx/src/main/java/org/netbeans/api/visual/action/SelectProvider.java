...
public interface SelectProvider {
	 ...
	 *            the aimed widget
	 * @param localLocation
	 *            the local location of a mouse cursor while aiming is invoked
	 *            by an user
	 * @param invertSelection
	 *            if true, then the invert selection is invoked by an user.
	 * @return true, if aiming is allowed and widget is set to aimed state while
	 *         mouse button is pressed; false, if aiming is disallowed and
	 *         widget is not set to aimed state at any time.
	 */
	 ...
	 *            the selected widget
	 * @param localLocation
	 *            the local location of a mouse cursor while selection is
	 *            invoked by an user
	 * @param invertSelection
	 *            if true, then the invert selection is invoked by an user.
