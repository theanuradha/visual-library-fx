...
/**
 * This is a factory of all built-in anchor implementations. Anchors are
 * designed to be shared by multiple instances of proxy anchors and connection
 * widgets.
 * 
 * @author David Kaspar
 */
public final class AnchorFactory {
	...
	/**
	 * Creates a proxy anchor with delegates the computation one of specified
	 * anchors based on state in a model.
	 * 
	 * @param model
	 *            the model with state
	 * @param anchors
	 *            the slave anchors
	 * @return the anchor
	 */
	...
	/**
	 * Creates an anchor with always computes a point in the center of specified
	 * widget.
	 * 
	 * @param widget
	 *            the widget
	...
	/**
	 * Creates an anchor which computes a point as the one on a circle around
	 * specified widget. The point is the closest one to location of opposite
	 * anchor.
	 * 
	 * @param widget
	 *            the widget
	...
	/**
	 * Creates an anchor which computes a point as the one on the boundary of
	 * spacified widget. The point is the closest one to location of opposite
	 * anchor.
	 * 
	 * @param widget
	 *            the widget
	 ...
	 *            if true, then the boundary is widget bounds; if null then the
	 *            boundary is widget client-area (bounds without borders)
	 * @return the anchor
	 */
	...
	/**
	 * Creates a directional anchor with computes a point as the one in the
	 * middle of the boundary side of specified widget. The side is the closest
	 * one to the opposite anchor.
	 * 
	 * @param widget
	 *            the widget
	 * @param kind
	...
	/**
	 * Creates a free rectangular anchor. IT is similar to rectangular anchor
	 * but it is designed to be used together with FreeRouter.
	 * 
	 * @param widget
	 *            the widget
	 * @param includeBorders
