...
/**
 * This is a widget with a level-of-details feature. The visibility of children
 * is based on the zoom factor of a scene.
 * <p>
 * For <code>&lt; hardMinimalZoom</code> and <code>&gt; hardMaximalZoom</code>
 * the children are not painted.<br>
 * For <code>&lt; softMinimalZoom</code> and <code>&gt; sortMaximalZoom</code>
 * the children are partially painted using alpha-blending.<br>
 * Between <code>softMinimalZoom</code> and <code>softMaximalZoom</code> the
...
public class LevelOfDetailsWidget extends Widget {
	 ...
	 * @param scene
	 *            the scene
	 * @param hardMinimalZoom
	 *            the hard minimal zoom factor
	 * @param softMinimalZoom
	 *            the sort minimal zoom factor
	 * @param softMaximalZoom
	 *            the sort maximal zoom factor
	 * @param hardMaximalZoom
	 *            the hard maximal zoom factor
	 */
	public LevelOfDetailsWidget(Scene scene, double hardMinimalZoom, double softMinimalZoom, double softMaximalZoom,
	...
	/**
	 * Checks whether a specified local location is a part of a widget based on
	 * the zoom factor.
	 * 
	 * @param localLocation
	 *            the local location
