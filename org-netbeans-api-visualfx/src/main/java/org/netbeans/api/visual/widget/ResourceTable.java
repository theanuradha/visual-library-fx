...
/**
 * The ResourceTable is used to manage a widgets resource. A ResourceTable can
 * have a parent ResourceTable. The values in the child resource table will
...
public class ResourceTable {
	...
	private ArrayList<WeakReference<PropertyChangeListener>> listeners = new ArrayList<WeakReference<PropertyChangeListener>>();

	private HashMap<String, ArrayList<WeakReference<PropertyChangeListener>>> propertyListeners = new HashMap<String, ArrayList<WeakReference<PropertyChangeListener>>>();
	...
	private ArrayList<WeakReference<ResourceTable>> childrenTables = new ArrayList<WeakReference<ResourceTable>>();
	...
	/**
	 * Add a resource property. If a property with the same name already exist,
	 * it will be overridden by the new property value. If the new value is
	 * null, the property will be removed from the table.
	 * 
	 * @param name
	...
	// {
	// return
	// (Set<String>)Collections.unmodifiableSet(colorProperties.keySet());
	// }
	//
	// public Set<String> getLocalPaintPropertyNames()
	// {
	// return
	// (Set<String>)Collections.unmodifiableSet(paintProperties.keySet());
	// }
	//
	...
	private void fireParentChangedChange(ResourceTable oldTable, ResourceTable newTable) {
		...
		// Since the parent table changed, the listeners property value may have
		// also changed.
	 ...
	 *            the name of the property.
	 * @param event
	 *            the event to send if the property is not overridden.
	 */
