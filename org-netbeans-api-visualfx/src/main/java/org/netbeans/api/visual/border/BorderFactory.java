...
/**
 * This class is a factory of all built-in implementation of borders. Instances
 * of built-in borders can be shared by multiple widgets.
 *
 * @author David Kaspar
 */
...
public final class BorderFactory {
	...
	/**
	 * Creates an default empty border with 0px layout. The instance can be
	 * shared by multiple widgets.
	 * 
	...
	/**
	 * Creates an empty border with specific thickness. The instance can be
	 * shared by multiple widgets.
	 * 
	 * @param thickness
	...
	/**
	 * Creates an opaque border with specific thickness. The instance can be
	 * shared by multiple widgets.
	 * 
	 * @param top
	 *            the top inset
	...
	/**
	 * Creates a composite border that consists of a list of specified borders -
	 * one embedded to another. The instance can be shared by multiple widgets.
	 * 
	 * @param borders
	 *            the list of borders
	...
	/**
	 * Creates a line border with default style. The instance can be shared by
	 * multiple widgets.
	 * 
	 ...
	 *            the property name
	 * @param associated
	 *            the widget used to retrieve the resource table.
	 * @return the line border
	 */
	...
	/**
	 * Creates a line border with specific thickness. The line is still one
	 * pixel but the layout insets are calculated from thickness. The instance
	 * can be shared by multiple widgets.
	 * 
	 * @param thickness
	 *            the border thickness
	 * @return the line border
	 ...
	 * still one pixel but the layout insets are calculated from thickness. The
	 * instance can be shared by multiple widgets.
	 * 
	 * @param thickness
	 *            the border thickness
	 * @param color
	 ...
	 * Creates a line border with specific thickness and color. The line is
	 * still one pixel but the layout insets are calculated from thickness. The
	 * color is specified by a resource property that is retrieved from a
	 ...
	 * one pixel but the layout insets are specified. The instance can be shared
	 * by multiple widgets.
	 * 
	 * @param top
	 *            the top inset
	...
	/**
	 * Creates a line border with specific insets and color. The line is still
	 * one pixel but the layout insets are specified. The color is specified by
	 * a resource property that is retrieved from a resource table. The resource
	 * table is retrieved from the associated widget.
	 * 
	 ...
	 * @return the line border
	 */
	public static Border createLineBorder(int top, int left, int bottom, int right, String property,
			Widget associated) {
	 ...
	 * Creates a line border with specific insets and color. The line is still
	 * one pixel but the layout insets are specified. The color is specified by
	 * a resource property that is retrieved from a resource table.
	 * 
	 * The instance can not shared by multiple widgets.
	 * 
	 * @param top
	 ...
	 * 
	 * @param raised
	 *            if true, then it is a raised-bevel border; if false, then it
	 *            is a lowered-bevel layout
	 ...
	 * 
	 * @param raised
	 *            if true, then it is a raised-bevel layout; if false, then it
	 *            is a lowered-bevel border
	 * @param color
	 *            the border color
	 * @return the bevel border
	 */
	...
	/**
	 * Creates an image layout. The border is painted using a supplied Image.
	 * The image is split into 3x3 regions defined by insets. The middle regions
	 * are tiled for supplying variable width and height of border. Central
	 * region is not painted. The instance can be shared by multiple widgets.
	 * 
	 * @param insets
	 *            the border insets
	 * @param image
	...
	/**
	 * Creates an image layout. The border is painted using a supplied Image.
	 * The image is split into 3x3 regions defined by imageInsets. The middle
	 * regions are tiled for supplying variable width and height of border.
	 * Central region is not painted. The insets of the border is specified by
	 * borderInsets. The instance can be shared by multiple widgets.
	 * 
	 * @param borderInsets
	 *            the border insets
	 * @param imageInsets
	 ...
	 * calculated from arcWidth and arcHeight. The instance can be shared by
	 * multiple widgets.
	 * 
	 * @param arcWidth
	 *            the arc width
	 ...
	 *            the arc height
	 * @param fillProperty
	 *            the property name for the fill color
	 * @param drawProperty
	 *            the property name for the draw color
	 * @param associated
	 *            the widget used to retrieve the resource table.
	 * @return the rounded border
	 */
	public static Border createRoundedBorder(int arcWidth, int arcHeight, String fillProperty, String drawProperty,
			Widget associated) {
		return createRoundedBorder(arcWidth, arcHeight, arcWidth, arcHeight, fillProperty, drawProperty, associated);
	}
	...
	public static Border createRoundedBorder(int arcWidth, int arcHeight, String fillProperty, String drawProperty,
			ResourceTable table) {
		return createRoundedBorder(arcWidth, arcHeight, arcWidth, arcHeight, fillProperty, drawProperty, table);
	}

	/**
	 * Creates an rounded-rectangle border with a specified style. The instance
	 * can be shared by multiple widgets.
	 * 
	 * @param arcWidth
	 *            the arc width
	 ...
	 */
	public static Border createRoundedBorder(int arcWidth, int arcHeight, int insetWidth, int insetHeight,
			String fillProperty, String drawProperty, ResourceTable table) {
	 ...
	 */
	public static Border createRoundedBorder(int arcWidth, int arcHeight, int insetWidth, int insetHeight,
			String fillProperty, String drawProperty, Widget associated) {
		return new RoundedBorder(arcWidth, arcHeight, insetWidth, insetHeight, fillProperty, drawProperty, associated);
	}

	/**
	 * Creates a resize border. Usually used as resizing handles for
	 * ResizeAction. It renders a bounding rectangle with 8-direction squares.
	 * The instance can be shared by multiple widgets.
	 * 
	 * @param thickness
	 ...
	 *            the thickness of the border
	 * @param property
	 *            the property name for the border color
	 * @param associated
	 *            the widget used to retrieve the resource table.
	 * @return the resize border
	 */
	 ...
	 *            the border color
	 * @param outer
	 *            if true, then the rectangle encapsulate the squares too; if
	 *            false, then the rectangle encapsulates the widget client area
	 *            only
	 * @return the resize border
	 */
	...
	/**
	 * Creates a resize border rendered with dashed stroke. The instance can be
	 * shared by multiple widgets.
	 * 
	 * @param color
	 *            the border color
	...
	/**
	 * Creates a resize border rendered with fancy dashed stroke. The instance
	 * can be shared by multiple widgets.
	 * 
	 * @param color
	 *            the border color
	 ...
	 * @deprecated use createDashedBorder (color, width, height, true) method
	 *             instead
	 */
	public static Border createFancyDashedBorder(Color color, int width, int height) {
		GeomUtil.LOG.warning(
				"BorderFactory.createFancyDashedBorder() method is deprecated. Use BorderFactory.createDashedBorder(color,width,height,true) method instead."); // NOI18N
		return new FancyDashedBorder(color != null ? color : Color.BLACK, width, height);
	}
