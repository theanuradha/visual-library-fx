...
public final class LayoutFactory {
	...
	public enum ConnectionWidgetLayoutAlignment {
		...
		NONE, CENTER, TOP_CENTER, BOTTOM_CENTER, CENTER_LEFT, CENTER_RIGHT, TOP_LEFT, TOP_RIGHT, BOTTOM_LEFT, BOTTOM_RIGHT, CENTER_SOURCE, CENTER_TARGET, BOTTOM_SOURCE, BOTTOM_TARGET, TOP_SOURCE, TOP_TARGET
	}
	...
	/**
	 * Creates an absolute layout where widgets are located at placed defined by
	 * their preferredLocation. The instance can be shared by multiple widgets.
	 * 
	...
	public static Layout createVerticalLayout() {
		GeomUtil.LOG.warning(
				"LayoutFactory.createVerticalLayout() method is deprecated. Use LayoutFactory.createVerticalFlowLayout() method instead."); // NOI18N
	...
	public static Layout createVerticalLayout(SerialAlignment alignment, int gap) {
		GeomUtil.LOG.warning(
				"LayoutFactory.createVerticalLayout(alignment,gap) method is deprecated. Use LayoutFactory.createVerticalFlowLayout(alignment,gap) method instead."); // NOI18N
	...
	public static Layout createHorizontalLayout(SerialAlignment alignment, int gap) {
		GeomUtil.LOG.warning(
				"LayoutFactory.createHorizontalLayout(alignment,gap) method is deprecated. Use LayoutFactory.createHorizontalFlowLayout(alignment,gap) method instead."); // NOI18N
	...
	/**
	 * Returns a fill layout where all children widgets has the boundary at the
	...
	/**
	 * Returns a scene layout which performs one-time layout using specified
	 * devolve-layout. The instance cannot be shared.
	 * 
	 * @param widget
	 *            the
	 * @param devolveLayout
	 *            the layout that is going to be used for one-time layout
	 * @param animate
	 ...
	 * @return the scene layout
	 */
	public static <N, E> SceneLayout createSceneGraphLayout(final GraphScene<N, E> graphScene,
			final GraphLayout<N, E> graphLayout) {
	 ...
	 * @return the scene layout
	 */
	public static <N, E> SceneLayout createSceneGraphLayout(final GraphPinScene<N, E, ?> graphPinScene,
			final GraphLayout<N, E> graphLayout) {
