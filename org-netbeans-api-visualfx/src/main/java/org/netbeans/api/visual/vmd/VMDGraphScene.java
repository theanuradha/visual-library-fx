...
/**
 * This class represents a GraphPinScene for the VMD visualization style. Nodes,
 * edges and pins are represented using String class. The visualization is done
 * by: VMDNodeWidget for nodes, VMDPinWidget for pins, ConnectionWidget fro
 * edges.
 * <p>
...
public class VMDGraphScene extends GraphPinScene<String, String, String> {
	 ...
	 * has object-hover and select action. The the node id ends with "#default"
	 * then the pin is the default pin of a node and therefore it is non-visual.
	 * 
	 * @param node
	 *            the node
	 * @param pin
	...
	private Anchor getPinAnchor(String pin) {
		...
		if (pinMainWidget != null) {
			anchor = AnchorFactory.createDirectionalAnchor(pinMainWidget,
					AnchorFactory.DirectionalAnchorKind.HORIZONTAL, 8);
