...
/**
 * This class represents a model with a single state which can be boolean or
 * non-negative integer value. It supports stateChanged event listening.
 *
 * @author David Kaspar
 */
public final class StateModel {
	 ...
	 * 
	 * @param state
	 *            the boolean state; if true, then 1 value is used; if false,
	 *            then 0 value is used
	 */
	...
	/**
	 * Decreases the state value. If new value would have to be negative, then
	 * the maxStates-1 value is used instead.
	 */
	...
	/**
	 * Increases the state value. If new value would have to be maxStates or
	 * higher, then the 0 value is used instead.
	 */
