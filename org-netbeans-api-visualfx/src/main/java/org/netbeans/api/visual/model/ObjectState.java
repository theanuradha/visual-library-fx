...
/**
 * This class holds a state of a object or a widget. The object state is a set
 * of those following flags: selected, highlighted (also called secondary
 * selection), object-hovered, widget-hovered, widget-aimed.
 * <p>
 * Initial (normal) value of object state is used for Widget.state and in
 * ObjectScene class.
 *
 * @author David Kaspar
 */
...
public class ObjectState {
	...
	private ObjectState(boolean objectSelected, boolean objectHighlighted, boolean objectHovered, boolean objectFocused,
			boolean widgetHovered, boolean widgetFocused, boolean widgetAimed) {
	...
	/**
	 * Creates a state derived from this one where the selected flag will be set
	 * according to the parameter.
	 * 
	 * @param selected
	 *            the new selected-flag of the new state.
	 * @return the new state
	 */
	public ObjectState deriveSelected(boolean selected) {
		return new ObjectState(selected, objectHighlighted, objectHovered, objectFocused, widgetHovered, widgetFocused,
				widgetAimed);
	}
	...
	/**
	 * Creates a state derived from this one where the highlighted flag will be
	 * set according to the parameter.
	 * 
	 * @param highlighted
	 *            the new highlighted-flag of the new state.
	 * @return the new state
	 */
	public ObjectState deriveHighlighted(boolean highlighted) {
		return new ObjectState(objectSelected, highlighted, objectHovered, objectFocused, widgetHovered, widgetFocused,
				widgetAimed);
	}
	...
	/**
	 * Creates a state derived from this one where the object-hovered flag will
	 * be set according to the parameter.
	 * 
	 * @param hovered
	 *            the new object-hovered-flag of the new state.
	 * @return the new state
	 */
	public ObjectState deriveObjectHovered(boolean hovered) {
		return new ObjectState(objectSelected, objectHighlighted, hovered, objectFocused, widgetHovered, widgetFocused,
				widgetAimed);
	}
	...
	/**
	 * Creates a state derived from this one where the widget-hovered flag will
	 * be set according to the parameter.
	 * 
	 * @param hovered
	 *            the new widget-hovered-flag of the new state.
	 * @return the new state
	 */
	public ObjectState deriveWidgetHovered(boolean hovered) {
		return new ObjectState(objectSelected, objectHighlighted, objectHovered, objectFocused, hovered, widgetFocused,
				widgetAimed);
	}
	...
	/**
	 * Creates a state derived from this one where the object-focused flag will
	 * be set according to the parameter.
	 * 
	 * @param focused
	 *            the new object-focused-flag of the new state.
	 * @return the new state
	 */
	public ObjectState deriveObjectFocused(boolean focused) {
		return new ObjectState(objectSelected, objectHighlighted, objectHovered, focused, widgetHovered, widgetFocused,
				widgetAimed);
	}
	...
	/**
	 * Creates a state derived from this one where the widget-focused flag will
	 * be set according to the parameter.
	 * 
	 * @param focused
	 *            the new widget-focused-flag of the new state.
	 * @return the new state
	 */
	public ObjectState deriveWidgetFocused(boolean focused) {
		return new ObjectState(objectSelected, objectHighlighted, objectHovered, objectFocused, widgetHovered, focused,
				widgetAimed);
	}
	...
	/**
	 * Creates a state derived from this one where the aimed flag will be set
	 * according to the parameter.
	 * 
	 * @param aimed
	 *            the new aimed-flag of the new state.
	 * @return the new state
	 */
	public ObjectState deriveWidgetAimed(boolean aimed) {
		return new ObjectState(objectSelected, objectHighlighted, objectHovered, objectFocused, widgetHovered,
				widgetFocused, aimed);
	}
