...
public final class VMDFactory {
	 ...
	 * @param color1
	 *            1. color of gradient background
	 * @param color2
	 *            2. color of gradient background
	 * @param color3
	 *            3. color of gradient background
	 * @param color4
	 *            4. color of gradient background
	 * @param color5
	 *            5. color of gradient background
	 * @since 2.5
	 */
	public static Border createVMDNodeBorder(Color borderColor, int borderThickness, Color color1, Color color2,
