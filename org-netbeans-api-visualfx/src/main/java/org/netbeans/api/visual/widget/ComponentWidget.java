...
/**
 * This widget allows to use an AWT/Swing component in the scene. The widget
 * itself just represents and reserve the place occupied by the component. When
 * a component is resized, then reserved place is recalculated. The component
 * placement is automatically update based on the placement of the widget. The
 * widget also paints the component in the satelite views.
 * <p>
 * When a widget is added into the scene, it has to attach a scene listener for
 * automatic recalculation. The attaching is done automatically for the first
 * time.
 *
 * @author David Kaspar
 */
