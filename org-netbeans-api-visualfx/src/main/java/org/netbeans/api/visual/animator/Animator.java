...
/**
 * Represents an animator. An animator is registed to a scene animator and could
 * be started. From that moment the scene animator automatically calls
 * Animator.tick method for a solid period of time set by the scene animator. In
 * the tick method the animation has to implemented. The animation should be
 * independent on time-duration.
 * <p>
 * Since 2.2, it is possible to listener on important events of the animator
 * using <code>AnimatorListener</code> interface.
 *
 * @author David Kaspar
 */
public abstract class Animator {
	...
	/**
	 * Called for performing the animation based on a progress value. The value
	 * is a double number in interval from 0.0 to 1.0 (including). The 0.0 value
	 * represents beginning, the 1.0 value represents the end.
	 * 
	 * @param progress
	 *            the progress
	 */
