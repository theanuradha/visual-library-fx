...
/**
 * The factory class of all built-in anchor shapes. The instances of all
 * built-in anchor shapes can be used multiple connection widgets.
 *
 * @author David Kaspar
 */
public class AnchorShapeFactory {
	 ...
	 *            the image
	 * @param lineOriented
	 *            if true, then the image is line oriented
	 * @return the anchor shape
	 */
	 ...
	 *            if true, then it is output triangle
	 * @param cutDistance
	 *            the distance where the related line is cut (usually 1px
	 ...
	 * 
	 * @param degrees
	 *            the angle of the arrow in degrees (not radians)
	 * @param size
	...
	/**
	 * Creates a proxy AnchorShape that is used to adjust the location of an
	 * AnchorShape. The associated AnchorShape will fit on the outside of the
	 * attached widget. The connection end and the attached widget is used to
	 * determine the location of the location of the AnchorShape.
	 * 
	 * @param shape
	 *            The shape that will be adjusted.
	 * @param owner
	 *            The owner of the AnchorShape.
	 * @param referencingEnd
	 *            The end of the connection to place the shape.
	 * @param attachedWidget
	 *            The widget on the shapes end.
	 */
	public static AnchorShape createAdjustableAnchorShape(AnchorShape shape, ConnectionWidget owner,
			ConnectionEnd referencingEnd, Widget attachedWidget) {
	...
	/**
	 * Creates a proxy AnchorShape that is used to adjust the location of an
	 * AnchorShape. the location of the associated AnchorShape will be
	 * determined by a AnchorShapeLocationResolver.
	 * 
	 * @param The
	 *            shape that will be adjusted.
	 * @param resolver
	 *            The AnchorShapeLocationResolver used to determine where to
	 *            place the shape.
	 */
	 ...
	 * AnchorsShapes location. The connection end and the attached widget is
	 * used to determine the location of the location of the AnchorShape.
	 * 
	 * @param owner
	 *            The owner of the AnchorShape.
	 * @param referencingEnd
	 ...
	 *            The widget on the shapes end.
	 */
	public static AnchorShapeLocationResolver createWidgetResolver(ConnectionWidget owner, ConnectionEnd referencingEnd,
