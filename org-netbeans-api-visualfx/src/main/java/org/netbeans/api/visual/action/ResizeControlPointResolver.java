...
/**
 * This interface is used by ResizeAction to resolve if and which control point
 * is being dragged for particular resizing.
 *
 * @author David Kaspar
 */
public interface ResizeControlPointResolver {
	 ...
	 * 
	 * @param widget
	 *            the widget where the user is invoking the resizing
	 * @param point
	 *            the mouse cursor location in local coordination system of the
	 *            widget
