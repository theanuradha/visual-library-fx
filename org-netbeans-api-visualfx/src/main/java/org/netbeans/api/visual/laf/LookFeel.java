...
public abstract class LookFeel {
	...
	/**
	 * Creates a default look and feel. The instance can be shared by multiple
	 * scenes.
	 * 
	...
	/**
	 * Returns a margin for a specific state. It is used with borders - usually
	 * the value is a inset value of a border.
	 * 
	 * @return the margin
	 */
	 ...
	 * widget.setBorder (getBorder (state)); widget.setOpaque (getOpaque
	 * (state)); widget.setBackground (getBackground (state));
