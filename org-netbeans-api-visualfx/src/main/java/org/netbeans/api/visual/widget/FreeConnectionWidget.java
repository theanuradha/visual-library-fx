...
/**
 * This class is an extension of the ConnectionWidget. Primarily it is used with
 * FreeRouter and optionally Free*Anchor. It has a method for adding and
 * removing control points on specific locations.
 *
 * @author Alex
 */
// TODO - later, logic of this class can be moved to the ConnectionWidget class
// directly
...
public class FreeConnectionWidget extends ConnectionWidget {
	...
	/**
	 * Creates a free connection widget with a specified create/delete
	 * sensitivity.
	 * 
	 * @param scene
	 *            the scene
	 * @param createSensitivity
	 *            the sensitivity for adding a control point
